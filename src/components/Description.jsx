...
export default function Description() {
  return (
    <section className="about" id="about">
      ...
      <div className="about-container">
        <div className="about-img">
          <img src={require('../photos/Vana - Futuristic City in the Sky 2023-05-30-10_42_52PM 9.png')} alt="Marco Viana" />
        </div>
        <div className="about-text">
          <p>
            Me chamo Marco, tenho 22 anos e moro em Ferraz de Vasconcelos. Tive meu primeiro contato com a tecnologia
            aos meus 16 anos de idade, quando cursei Desenvolvimento de Sistemas na Etec. Hoje, apaixonado por
            programação, estou sempre buscando aperfeiçoar minhas skills enquanto desenvolvo projetos FullStack com a
            Trybe, uma escola de programação Web.
          </p>
        </div>
      </div>
      <div className="information">
